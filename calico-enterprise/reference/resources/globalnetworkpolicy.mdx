---
description: Reference for the GlobalNetworkPolicy resource in Calico Enterprise, a cluster-scoped tiered policy that selects endpoints across all namespaces.
---
...
import SelectorScopes from '@site/calico-enterprise/_includes/content/_selector-scopes.mdx';
...
import Httpmatch from '@site/calico-enterprise/_includes/content/_httpmatch.mdx';
